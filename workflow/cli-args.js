const BOOLEAN_FLAGS = new Set([
  'allow-action', 'allow-ours-last', 'allow-positive', 'auto', 'batch', 'contains', 'dry-run',
  'force', 'full', 'has-remote', 'help', 'jd', 'resume-chat', 'retry-failed', 'status', 'use-saved', 'user-selected',
]);
...
module.exports = { parseCliArgs, arg, positionals, positional, jobIdOf, isRealJobUrl };
